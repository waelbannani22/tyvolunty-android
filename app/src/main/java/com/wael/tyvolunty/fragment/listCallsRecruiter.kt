...
class listCallsRecruiter : Fragment(R.layout.list_calls_fragment) {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_list_calls_recruiter, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.e("idrecruiiiiiiiteeeeeeeeeeeeeeerrrrrr", map["idrecruiter"].toString())
